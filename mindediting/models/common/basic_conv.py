...
from mindediting.utils.init_weights_mimounet import KaimingUniform, UniformBias
...
class BasicConv(nn.Cell):
    ...
    def __init__(self, in_channel, out_channel, kernel_size, stride, bias=True, norm=False, relu=True, transpose=False):
        ...
        if transpose:
            ...
            layers.append(
                Conv2dTransposeLikeTorch(
                    in_channel, out_channel, kernel_size, pad_mode="pad", padding=padding, stride=stride, has_bias=bias
                )
            )
        else:
            layers.append(
