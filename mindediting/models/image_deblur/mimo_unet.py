...
from mindediting.models.common.resblock_mimounet import ResBlock
...
class MIMOUNet(nn.Cell):
    ...
    def __init__(self, num_res=8):
        ...
        self.AFFs = nn.CellList([AFF(base_channel * 7, base_channel * 1), AFF(base_channel * 7, base_channel * 2)])
